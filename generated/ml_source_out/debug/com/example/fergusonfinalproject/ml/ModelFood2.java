package com.example.fergusonfinalproject.ml;
...
public final class ModelFood2 {
  @NonNull
  private final Model model;

  private ModelFood2(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "model_food2.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelFood2 newInstance(@NonNull Context context) throws IOException {
    return new ModelFood2(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelFood2 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new ModelFood2(context, options);
  }
